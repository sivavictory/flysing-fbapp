angular.module('flysingapp-fb.controllers', [])
    ...
    .controller('LoginCtrl', function ($scope, $location, OpenFB) {
        ...
        $scope.facebookLogin = function () {
            OpenFB.login('email,public_profile,user_friends,user_photos,user_posts,publish_actions,user_birthday,user_managed_groups').then(
            //OpenFB.login('email,read_stream,publish_stream').then(
                function () {
                    $location.path('/app/person/me/feed');
                   // $location.path('/app/person/me/profile');
    ...
    .controller('ShareCtrl', function ($scope, OpenFB) {
        ...
        $scope.share = function () {
            OpenFB.post('/v2.7/1748802928714910/feed', $scope.item)
    ...
    .controller('FeedCtrl', function ($scope, $stateParams, OpenFB, $ionicLoading) {
        ...
        function loadFeed() {
            $scope.show();
            OpenFB.get('/v2.7/1748802928714910/feed', {limit: 30})
